                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form name="input" method="post" action="nilai/nilai_update.php">
                                ...
                                <label for="fmatkul"> ID Mata Kuliah</label>
                                <input type="text" id="fmatkul" name="matkul" value="<?php echo $row['ID_Matkul']?>" readonly>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="login" method="post" action="nilai/nilai_input.php">
                    ...
                    <label for="fmatkul"> ID Mata Kuliah</label>
                    <input type="text" id="fmatkul" name="matkul" list="matkul" placeholder=" ID Mata Kuliah">
                        <datalist>
                        <?php
